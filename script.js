...
const new_numbers = numbers.filter (num => num % 5 === 0);
...
const brands = ['Nike', 'Adidas', 'Puma', 'Zara', 'Balenciaga', 'Everlane', 'Dior', 'Chanel', 'Shein', 'Gucci'];

const new_brands = brands.filter (index => index.includes ('a'));
